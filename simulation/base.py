...
class LTFArray(Simulation):
    ...
    **Combiner Function.**
    ...
    def __init__(self, weight_array: ndarray, transform: Union[str, Callable], temperature: float= None, vdd: float=None, T_factor: bool =None, V_factor: bool=None, combiner: Union[str, Callable] = 'xor',
        ...
        if temperature is None:
            temperature = 20  # or your normal default
        if vdd is None:
            vdd = 1.35  # or your normal default
...
class NoisyLTFArray(LTFArray):
    ...
    def __init__(self, weight_array, bias=None, transform=None, combiner='xor',
                 ...
                 temperature: float = 20, vdd: float = 1.35, T_factor: bool = None, V_factor: bool = None):
        super().__init__(
