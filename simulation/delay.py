...
class XORArbiterPUF(NoisyLTFArray):
    ...
    def __init__(self, n: int, k: int, seed: int = None, transform: Union[Callable, str] = None,
                 noisiness: float = 0, temperature: float = None, vdd: float = None, T_factor: bool = None, V_factor: bool = None) -> None:
        if seed is None:
            seed = 'default'
...
class ArbiterPUF(XORArbiterPUF):
    ...
    def __init__(self, n: int, seed: int = None, transform: Union[Callable, str] = None, noisiness: float = 0,temperature: float = None,
        vdd: float = None, T_factor: bool = None, V_factor: bool = None ) -> None:
        super().__init__(
            n=n,
            k=1,
            seed=seed,
